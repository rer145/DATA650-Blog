...
Using knitr as the global option for how the article is created, RStudio provides a compile PDF button. The result of which, can be viewed [here](janeausten.pdf)